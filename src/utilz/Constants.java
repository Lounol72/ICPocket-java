...
public class Constants {
    ...
    public static class PLAYER {
        ...
        public static class HURTBOX {
            private static final int HURTBOX_WIDTH_DEFAULT = 48;
            private static final int HURTBOX_HEIGHT_DEFAULT = 24;
            public static final int HURTBOX_WIDTH = (int) (HURTBOX_WIDTH_DEFAULT * SCALE);
